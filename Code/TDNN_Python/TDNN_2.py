...
def weight_variable_from_file(weight_file):
    weights=np.load(weight_file)
    #initial = tf.truncated_normal(shape, stddev=0.1)
    return tf.Variable(weights)


def bias_variable_from_file(bias_file):
...
W_conv1 = weight_variable_from_file("weight_1.npy")
b_conv1 = bias_variable_from_file("bias_1.npy")
...
# second  layer
W_conv2 = weight_variable_from_file("weight_2.npy")
b_conv2 = bias_variable_from_file("bias_2.npy")
...
# Third  layer
W_conv3 = weight_variable_from_file("weight_3.npy")
b_conv3 = bias_variable_from_file("bias_3.npy")
...
plt.plot(iteration, Accuracy, linewidth=2.5, linestyle='-', label='train accuracy')
plt.legend()
